cmd_drivers/crypto/fsl/error.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/crypto/fsl/.error.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -Iinclude  -I/home/wjy/Desktop/llll/packages/firmware/u-boot/include  -I/home/wjy/Desktop/llll/packages/firmware/u-boot/arch/arm/include -include /home/wjy/Desktop/llll/packages/firmware/u-boot/include/linux/kconfig.h  -I/home/wjy/Desktop/llll/packages/firmware/u-boot/drivers/crypto/fsl -Idrivers/crypto/fsl -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -DBOARD_MCU -march=armv8-a -D__LINUX_ARM_ARCH__=8    -D"KBUILD_STR(s)=$(pound)s" -D"KBUILD_BASENAME=KBUILD_STR(error)"  -D"KBUILD_MODNAME=KBUILD_STR(error)" -c -o drivers/crypto/fsl/error.o /home/wjy/Desktop/llll/packages/firmware/u-boot/drivers/crypto/fsl/error.c

source_drivers/crypto/fsl/error.o := /home/wjy/Desktop/llll/packages/firmware/u-boot/drivers/crypto/fsl/error.c

deps_drivers/crypto/fsl/error.o := \
...
drivers/crypto/fsl/error.o: $(deps_drivers/crypto/fsl/error.o)
